...
const STORAGE_KEY = "irbid-maternity-survey-answers";
...
export default function App() {
  ...
  const handleAnswer = (questionId: string, value: string) => {
    setAnswers((currentAnswers) => {
      ...
      if (questionId === "lab_received" && value === "no") {
        delete nextAnswers.lab_comfort;
      }

      if (questionId === "radiology_received" && value === "no") {
        delete nextAnswers.radiology_waiting;
        delete nextAnswers[getWaitingDurationAnswerId("radiology_waiting")];
        delete nextAnswers.radiology_comfort;
      }

      if (questionId === "pharmacy_received" && value === "no") {
        delete nextAnswers.pharmacy_waiting;
        delete nextAnswers[getWaitingDurationAnswerId("pharmacy_waiting")];
        delete nextAnswers.pharmacy_explanation;
        delete nextAnswers.pharmacy_availability;
      }
